...
export const Dictionary: React.FC<SVGMotionProps<SVGSVGElement>> = ({ ...rest }) => {
  ...
  return (
    ...
    >
      <path
        d="M4,14.2h1.1l0.6-1.6h2.6l0.6,1.6H10L7.6,7.8H6.4L4,14.2z M6,11.6L7,9H7L8,11.6H6z M14,9.9V8.2c0.6-0.2,1.1-0.4,1.7-0.5
