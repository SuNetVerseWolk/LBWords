...
export const RelaxSVG: FC<CustomSVGProps> = ({ hovered, pathProps, pathMotionProps, ...rest }) => {
  return (
    <motion.svg
			{...rest}
      animate={{
    ...
    >
      <path
				{...pathProps}
        d="M12,21c-0.3,0-0.6-0.1-0.9-0.2c-0.3-0.1-0.5-0.3-0.7-0.5l-6.7-6.7c-0.2-0.2-0.4-0.5-0.6-0.8c-0.2-0.3-0.4-0.6-0.5-0.9h9.3
      ...
      <motion.path
        ...
        className={`fill-main ${pathMotionProps?.className}`}
      ...
      <path
				{...pathProps}
        className={`fill-main ${pathProps?.className}`}
        d="M14.9,8.7L13,8.2c0.2-0.7,0.5-1.2,1.1-1.6S15.2,6,15.9,6c0.8,0,1.5,0.3,2.1,0.9c0.6,0.6,0.9,1.3,0.9,2.1
      ...
      <path
				{...pathProps}
        d="M11.9,21c-0.3,0-0.6-0.1-0.9-0.2c-0.3-0.1-0.5-0.3-0.7-0.5L4,14h2.8l4.9,4.9c0,0,0.1,0.1,0.1,0.1c0,0,0.1,0,0.1,0
